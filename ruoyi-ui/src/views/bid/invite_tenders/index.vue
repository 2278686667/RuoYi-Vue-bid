    ...
    <el-dialog :title="title" :visible.sync="pingbiaoopen" width="500px">
      <el-form :model="form" :rules="rulesping">
        ...
        <el-form-item label="本次评标需要" label-width="120px" prop="count">
          <el-input v-model.nmber="form.count" autocomplete="off" style="width: 50px"></el-input>
          名专家
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    details_page(row) {
      console.log(row)
      this.$router.push({
        path: "bid/detailsPage/index.vue",
        query: {id: row.projId}
